    ...
    <IonPage>
      <IonHeader className="ion-no-border">
        <IonToolbar className="premium-header-bg">
          <IonTitle className="premium-title">Driver Account</IonTitle>
        </IonToolbar>
      </IonHeader>
          ...
          <div className="profile-header-premium">
            <div className="profile-user-info">
              ...
              <div className="profile-rating-badge">
                ...
                <span>{rideCount} trip{rideCount !== 1 ? "s" : ""}</span>
                {memberSince && <span className="member-since">&bull; Since {memberSince}</span>}
              </div>
            </div>
            <IonAvatar className="profile-large-avatar">
              <img
                src={`https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || "D")}&background=random`}
                alt="Profile"
              />
            </IonAvatar>
          </div>
        ...
        <div className="profile-card">
          <IonList className="profile-list" lines="none">
            ...
            <IonItem button detail className="profile-item" onClick={() => history.push("/verification")}>
              ...
              <IonLabel>Documents & Verification</IonLabel>
            </IonItem>
